...
write.csv(tpm_ribo_cell_lines, "/translational_efficiency/results/tables/ribo_TPM_CDSs.csv")
write.csv(tpm_rna_cell_lines, "/translational_efficiency/results/tables/rna_TPM_CDSs.csv")
```
...
write.csv(te_mat, "/translational_efficiency/results/tables/raw_te_matrix.csv")
...
ggsave(filename = "/translational_efficiency/results/plots/1D_centered.pdf", width = unit(5, "cm"), height = unit(3, "cm"))
```
...
ggsave(plt_fixed, device = "pdf", filename = "/translational_efficiency/results/plots/1C_TE_CDS_PCA.pdf",
width = unit(5, "cm"),
height = unit(5, "cm"))
