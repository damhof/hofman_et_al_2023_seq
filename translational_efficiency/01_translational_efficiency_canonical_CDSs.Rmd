...
Output files
- .csv file containing table with TE values for cell line samples (Table S1G)
- PDF file with plot of TE value distributions for MYC high and MYC low samples (Fig 1D)
...
rna_counts <- read.csv("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_for_te/results/S1_RNA_for_te_canonical_counts.csv", check.names = F, row.names = 1)
...
ribo_counts <- read.csv("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/riboseq/results/tables/S1_riboseq_canonical_counts.csv", check.names = F, row.names = 1)
...
gene_lengths <- read.table(
  "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_for_te/data/processed/featureCounts/Medullo_RNA_GRCh38.102.geneCountsCDS.txt",
  check.names = F, 
  header = T, 
  row.names = 1) 
...
```{r}
# Write ribo counts and RNA TPMs to file
write.csv(tpm_ribo_cell_lines, "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/translational_efficiency/results/tables/ribo_TPM_CDSs.csv")
write.csv(tpm_rna_cell_lines, "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/translational_efficiency/results/tables/rna_TPM_CDSs.csv")
```
...
write.csv(te_mat, "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/translational_efficiency/results/tables/raw_te_matrix.csv")
...
ggsave(filename = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/translational_efficiency/results/plots/1D_centered.pdf", width = unit(5, "cm"), height = unit(3, "cm"))
```

```{r}
# select the ntop genes by variance
# te_mat_scale <- te_tpm_mat
...
ggsave(plt_fixed, device = "pdf", filename = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/translational_efficiency/results/plots/1C_TE_CDS_PCA.pdf",
width = unit(5, "cm"),
height = unit(5, "cm"))
