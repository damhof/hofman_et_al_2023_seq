...
```{r}
ribo_files <- list.files("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/riboseq/data/processed/RiboseQC/", "results_RiboseQC_all", recursive = T, full.names = T)
...
```{r}
ribo_file <- "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/riboseq/data/processed/RiboseQC.merged/Medullo_merged/_results_RiboseQC_all"
...
# p1
# Save plot
# ggsave(filename = paste0(sample, "_periodicity.pdf"),
#        plot = g3, 
#        device = "pdf", 
#        scale = 1, 
#        path = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses/02_results/riboseq_analysis/plots/periodicity/")
# 
...
cowplot::save_plot(filename = paste0("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/riboseq/results/plots/", sample, "_periodicity_new.pdf"), p3, ncol = 2, base_height = 3, base_width = 4)
