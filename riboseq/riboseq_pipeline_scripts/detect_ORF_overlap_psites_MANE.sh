...
# Set input variables
orf_gtf="/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/annotation_files/MANE.GRCh38.v1.0.ensembl_genomic.nochr.gtf"  # GTF file containing ORF definitions (eg CDS regions)
is_anno="yes"  # Is orf_GTF an annotation file with incomplete ORFs? (i.e. from Ensembl) [yes/no]
out_dir="${outdir}/psite_quantification/Medullo_Psites_quant_MANE"  # Directory to output generated files
riboseqc_dir="${outdir}/RiboseQC/"  # Parent directory containing RiboseQC results of all samples
analysis_name="Medullo_Psites_quant_MANE"  # Name of analysis run
