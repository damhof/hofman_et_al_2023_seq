...
```{r file-locations}
# Metadata file
metadata_location <- "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/01.26.2023_Table_S1.xlsx"

# ORF reference table
ref_table_location <- "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/annotation_files/all_ORFs_ref_table.csv"
```
...
```{r load-data}
counts_psites <- read.csv("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/riboseq/results/tables/S1_riboseq_P_sites_counts.csv", row.names = 1, check.names = F)
...
write.csv(res_df, "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses/02_results/notebooks/orf_quantification/ORF_level_diff_transl_analysis_results.csv")
```
...
# ggsave(plot = plt, 
# filename = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses/02_results/figures/1G_v2.pdf", device = "pdf", path = , width = unit(6, "cm"), height = unit(6, "cm"))
...
ggsave(plot = ASDURF_plt,
       filename = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses/02_results/figures/S4A_ASDURF_Riboseq.pdf", device = "pdf", path = , width = unit(6, "cm"), height = unit(6, "cm"))
