...
canonical_RNA_counts_all <- read.table("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_regular/data/processed/featurecounts/medullo_allsamples.counts", check.names = F)
...
# Write to .csv
write.csv(canonical_RNA_counts_all, "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_regular/results/tables/S1_RNA_fulllength_canonical_counts.csv", quote = F)
```
...
# Load metadata
sample_metadata <- readxl::read_xlsx("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/01.26.2023_Table_S1.xlsx", sheet = 1, col_names = T, skip = 2, .name_repair = "universal")
...
ggsave(plt_fixed, device = "pdf", filename = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_regular/results/plots/1E_RNA_CDS_DEA_PCA.pdf",
       width = unit(5, "cm"),
       height = unit(5, "cm"))
```
...
msigdb.hs <- readRDS("/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_regular/data/msigdb_hs.rds")
...
write.csv(fgseaRes_all_df, "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_regular/results/tables/S1_GSEA_results_all.csv", quote = F, row.names = F)
```
...
ggsave(
  device = "pdf", filename = "/hpc/pmc_vanheesch/projects/Damon/Medulloblastoma_analyses_final/rnaseq_regular/results/plots/S1F_GSEA_results.pdf", width = unit(5, "cm"), height = unit(4, "cm"))
