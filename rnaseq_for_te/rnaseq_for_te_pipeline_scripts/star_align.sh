...
if [[ -s "${outdir}/star/${sample_id}/${sample_id}.Aligned.sortedByCoord.out.bam" ]]; then
...
samtools index -@ 16 "${outdir}/star/${sample_id}/${sample_id}.Aligned.sortedByCoord.out.bam"
